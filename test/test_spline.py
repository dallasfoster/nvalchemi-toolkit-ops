...
"""
Test Suite for B-Spline Interpolation Module
=============================================

Tests for:
1. B-spline weight functions (partition of unity, derivative accuracy)
2. Spread operation (charge conservation)
3. Gather operation (interpolation accuracy)
4. Gather gradient operation (force computation)
5. Autograd functionality
"""
...
class TestMultiChannelSplineSpread:
    ...
    def test_spread_channels_output_shape(self, device, num_channels):
        ...
        from nvalchemiops.spline import spline_spread_channels
...
class TestMultiChannelSplineGather:
    ...
    def test_gather_channels_output_shape(self, device, num_channels):
        ...
        from nvalchemiops.spline import spline_gather_channels
...
class TestBSplineDeconvolution:
    ...
    def test_deconvolution_1d(self):
        ...
        from nvalchemiops.spline import compute_bspline_deconvolution_1d
