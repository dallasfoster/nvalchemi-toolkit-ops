...
from nvalchemiops.interactions.electrostatics.pme import (
    particle_mesh_ewald,
...
class TestPMECorrectnessTorchPME:
    ...
    def test_reciprocal_energy_positions_grad_matches_torchpme(
        ...
        # assert torch.allclose(our_forces.norm(), torchpme_forces.norm(), rtol=1e-2, atol=1e-3), f"Forces mismatch: ours={our_forces.norm()}, torchpme={torchpme_forces.norm()}"
        #     # f"Forces mismatch: ours={our_forces[:10]}, torchpme={torchpme_forces[:10]}"
        # )
