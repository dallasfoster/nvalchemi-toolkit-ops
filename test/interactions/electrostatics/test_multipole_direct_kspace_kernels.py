...
r"""Unit tests for the direct-k-space multipole Warp kernels."""
...
# =============================================================================
# Receiver-basis φ̂ kernel tests
# =============================================================================
...
# =============================================================================
# Fused feature-projection kernel tests
# =============================================================================
...
# =============================================================================
# Second-order backward kernels — each test FD-checks the analytic backward
# against the forward kernel at float64.
# =============================================================================
...
def _fd_kernel_output(call, *arrays, eps: float = 1e-6):
    ...
    # Each test below rolls its own small FD loop.
